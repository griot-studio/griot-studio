  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-xs uppercase tracking-wider text-griot-text-muted">ou</span>
        <div className="flex-1 h-px bg-white/5" />
      </div>
...
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-griot-bg text-griot-text flex flex-col items-center justify-center px-6">
      <Link href="/" className="font-heading text-2xl font-bold tracking-tight mb-12">
      ...
      <div className="w-full max-w-md bg-griot-surface border border-white/5 rounded-xl p-8">
        <h1 className="font-heading text-2xl font-semibold mb-2">Bienvenue</h1>
        ...
        <Suspense fallback={
          <div className="h-40 flex items-center justify-center text-griot-text-muted text-sm">
            Chargement…
          </div>
        }>
          <LoginForm />
